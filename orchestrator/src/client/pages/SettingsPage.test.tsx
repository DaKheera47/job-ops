...
const baseSettings: AppSettings = {
  ...
  gradcrackerEnabled: true,
  defaultGradcrackerEnabled: true,
  overrideGradcrackerEnabled: null,
  ukvisajobsEnabled: true,
  defaultUkvisajobsEnabled: true,
  overrideUkvisajobsEnabled: null,
  indeedEnabled: true,
  defaultIndeedEnabled: true,
  overrideIndeedEnabled: null,
  linkedinEnabled: true,
  defaultLinkedinEnabled: true,
  overrideLinkedinEnabled: null,
