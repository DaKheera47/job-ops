...
export function normalizeRxResumeMode(raw: string | null | undefined): RxResumeMode {
  return raw === "v4" ? "v4" : "v5";
}

export function getRxResumeBaseResumeIdKey(mode: RxResumeMode): Extract<
  SettingKey,
  "rxresumeBaseResumeIdV4" | "rxresumeBaseResumeIdV5"
> {
...
export function resolveRxResumeBaseResumeIdForMode(
  ...
  const modeSpecific =
    mode === "v4" ? settings.rxresumeBaseResumeIdV4 : settings.rxresumeBaseResumeIdV5;
